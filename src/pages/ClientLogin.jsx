...
import { User, Lock, ArrowRight, AlertCircle, Package } from "lucide-react";
    ...
    >
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 py-20 bg-gradient-to-b from-[#f0f4ff]/50 via-white to-white">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          >
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary rounded-2xl shadow-[0_8px_25px_rgba(0,71,204,0.3)] mb-4">
              <Package className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-3xl font-extrabold font-display text-dark tracking-tight">Client Portal</h1>
            <p className="text-slate-500 mt-2 font-sans">Sign in to manage your shipments</p>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Email */}
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1.5 font-display">Email Address</label>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-2 py-3.5 bg-primary text-white font-bold uppercase font-display tracking-wider rounded-xl shadow-[0_8px_25px_rgba(0,71,204,0.3)] hover:shadow-[0_0_20px_rgba(0,180,216,0.6)] border border-blue-400/20 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isLoading ? (
            ...
            <div className="bg-blue-50/60 rounded-xl p-4 border border-blue-100/50">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-500 mb-2">
                ...
                <span className="font-display uppercase tracking-wider">Test Account</span>
              </div>
              <p className="text-xs text-slate-600 font-mono">
                Email: <span className="text-primary font-semibold">client@nexafreight.com</span><br />
                Password: <span className="text-primary font-semibold">client123</span>
              </p>
            </div>
          </motion.div>
          ...
          >
            <p className="text-xs text-slate-400 font-sans">
              Are you an administrator? <Link to="/admin/login" className="text-primary font-semibold hover:underline">Admin Login →</Link>
            </p>
            <p className="text-xs text-slate-400 font-sans">
