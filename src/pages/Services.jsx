  ...
  const servicesList = [
    {
      ...
      subtitle: "Smart Fleets & Platooning",
      description: "Electric vehicle convoys utilizing advanced sensors and route planning to navigate highways safely and maximize fuel efficiency.",
      stats: { metric: "24/7", label: "Continuous Transit" },
    ...
    },
    {
      ...
      subtitle: "Global Aviation Networks",
      description: "Priority air freight utilizing optimized flight corridors and fast regional connections to bypass shipping bottlenecks, delivering cargo transcontinentally in under 6 hours.",
      stats: { metric: "< 6 Hrs", label: "Express Transit" },
    ...
    },
    {
      ...
      subtitle: "Real-time Container Tracking",
      description: "Smart shipping containers transmitting interior humidity, movement, and temperature metrics combined with port automation for reliable ocean shipping.",
      stats: { metric: "100%", label: "Container Monitoring" },
      glow: "hover:shadow-[0_15px_40px_rgba(0,71,204,0.14)]"
    },
    {
      id: "warehouse",
      icon: <Database className="w-8 h-8 text-primary" />,
      title: "Robotic Warehousing",
      subtitle: "Automated Micro-Fulfillment",
      description: "Lights-out distribution centers powered by automated guided vehicles (AGVs) and sorting cranes. Robotic picking rates achieve 99.98% accuracy without manual oversight.",
      stats: { metric: "99.98%", label: "Robotic Accuracy" },
      glow: "hover:shadow-[0_15px_40px_rgba(0,180,216,0.14)]"
    },
    {
      id: "lastmile",
      icon: <Navigation className="w-8 h-8 text-primary" />,
      title: "Drones Last-Mile Delivery",
      subtitle: "Local Delivery Drones",
      description: "Delivery drones carrying lightweight payloads (up to 15kg) directly to landing platforms at retail hubs, bypassing city traffic congestion.",
      stats: { metric: "15 Mins", label: "Average Delivery Time" },
      glow: "hover:shadow-[0_15px_40px_rgba(0,71,204,0.14)]"
    },
    {
      id: "coldchain",
      icon: <ThermometerSnowflake className="w-8 h-8 text-primary" />,
      title: "Biotech Cold Chain",
      subtitle: "Active Temperature Controls",
      description: "Specialized cold chain monitoring for sensitive pharmaceutical, medical, and biological items with precise temperature controls down to -80°C.",
      stats: { metric: "-80°C", label: "Cold-Storage Capable" },
      glow: "hover:shadow-[0_15px_40px_rgba(0,180,216,0.14)]"
    }
  ];
